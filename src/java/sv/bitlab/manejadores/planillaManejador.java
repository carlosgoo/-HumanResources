...
public class planillaManejador extends ManejadorAbstracto<Planilla> {
    ...
    private List<Planilla> planillaPorCodigo;
    private List<Planilla> historialPlanillas;
   ...
   @PostConstruct
   public void historialPlanilla(){
       historialPlanillas = planillaControlador.encontrarEntidades();
   }
    ...
    public void generarPlanilla() {
        try {
            ...
            planillaPorCodigo = planillaControlador.planillaPorCodigo(codigo);
    ...
    public List<Planilla> getPlanillaPorCodigo() {
        return planillaPorCodigo;
    }

    public void setPlanillaPorCodigo(List<Planilla> planillaPorCodigo) {
        this.planillaPorCodigo = planillaPorCodigo;
    }
    ...
    public List<Planilla> getHistorialPlanillas() {
        return historialPlanillas;
    }

    public void setHistorialPlanillas(List<Planilla> historialPlanillas) {
        this.historialPlanillas = historialPlanillas;
    }
